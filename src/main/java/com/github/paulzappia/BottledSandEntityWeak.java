...
public class BottledSandEntityWeak extends ThrownItemEntity {

    public BottledSandEntityWeak(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public BottledSandEntityWeak(World world, LivingEntity owner) { super(EntityType.SNOWBALL, owner, world); }

    public BottledSandEntityWeak(World world, double x, double y, double z) { super(EntityType.SNOWBALL, x, y, z, world); } //{ super(EntityType.EGG, x, y, z, world); }
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.world.isClient) {
                    ...
                    // Weak
                    StatusEffectInstance statusEffectInstance = new StatusEffectInstance(StatusEffects.BLINDNESS, 100, 2);
