...
public class BottledSandEntityStrong extends ThrownItemEntity {

    public BottledSandEntityStrong(EntityType<? extends ThrownItemEntity> entityType, World world) {
        super(entityType, world);
    }

    public BottledSandEntityStrong(World world, LivingEntity owner) { super(EntityType.SNOWBALL, owner, world); }

    public BottledSandEntityStrong(World world, double x, double y, double z) {
    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (!this.world.isClient) {
                    ...
                    // Strong
                    StatusEffectInstance statusEffectInstance1 = new StatusEffectInstance(StatusEffects.BLINDNESS, 300, 2);
                    StatusEffectInstance statusEffectInstance2 = new StatusEffectInstance(StatusEffects.SLOWNESS, 300, 2);
